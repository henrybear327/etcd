...
type HealthRequest struct {
	// Types that are valid to be assigned to HealthCheckSelector:
	//
	//	*HealthRequest_Exclude
	//	*HealthRequest_Allowlist
	HealthCheckSelector  isHealthRequest_HealthCheckSelector `protobuf_oneof:"healthCheckSelector"`
	XXX_NoUnkeyedLiteral struct{}                            `json:"-"`
	XXX_unrecognized     []byte                              `json:"-"`
	XXX_sizecache        int32                               `json:"-"`
}
...
type isHealthRequest_HealthCheckSelector interface {
	isHealthRequest_HealthCheckSelector()
	MarshalTo([]byte) (int, error)
	Size() int
}

type HealthRequest_Exclude struct {
	Exclude *HealthRequest_StringArray `protobuf:"bytes,1,opt,name=exclude,proto3,oneof" json:"exclude,omitempty"`
}
type HealthRequest_Allowlist struct {
	Allowlist *HealthRequest_StringArray `protobuf:"bytes,2,opt,name=allowlist,proto3,oneof" json:"allowlist,omitempty"`
}
...
func (m *HealthRequest) GetHealthCheckSelector() isHealthRequest_HealthCheckSelector {
	if m != nil {
		return m.HealthCheckSelector
	}
	return nil
}

func (m *HealthRequest) GetExclude() *HealthRequest_StringArray {
	if x, ok := m.GetHealthCheckSelector().(*HealthRequest_Exclude); ok {
		return x.Exclude
	}
	return nil
}

func (m *HealthRequest) GetAllowlist() *HealthRequest_StringArray {
	if x, ok := m.GetHealthCheckSelector().(*HealthRequest_Allowlist); ok {
		return x.Allowlist
	}
	return nil
}
...
// XXX_OneofWrappers is for the internal use of the proto package.
func (*HealthRequest) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*HealthRequest_Exclude)(nil),
		(*HealthRequest_Allowlist)(nil),
	}
}

type HealthRequest_StringArray struct {
...
func (m *HealthRequest_StringArray) Reset()         { *m = HealthRequest_StringArray{} }
func (m *HealthRequest_StringArray) String() string { return proto.CompactTextString(m) }
func (*HealthRequest_StringArray) ProtoMessage()    {}
func (*HealthRequest_StringArray) Descriptor() ([]byte, []int) {
	return fileDescriptor_77a6da22d6a3feb1, []int{57, 0}
}
func (m *HealthRequest_StringArray) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *HealthRequest_StringArray) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_HealthRequest_StringArray.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *HealthRequest_StringArray) XXX_Merge(src proto.Message) {
	xxx_messageInfo_HealthRequest_StringArray.Merge(m, src)
}
func (m *HealthRequest_StringArray) XXX_Size() int {
	return m.Size()
}
func (m *HealthRequest_StringArray) XXX_DiscardUnknown() {
	xxx_messageInfo_HealthRequest_StringArray.DiscardUnknown(m)
}

var xxx_messageInfo_HealthRequest_StringArray proto.InternalMessageInfo

func (m *HealthRequest_StringArray) GetValues() []string {
	if m != nil {
		return m.Values
	}
	return nil
...
func (m *HealthResponse) GetHeader() *ResponseHeader {
	if m != nil {
		return m.Header
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*HealthRequest)(nil), "etcdserverpb.HealthRequest")
	proto.RegisterType((*HealthRequest_StringArray)(nil), "etcdserverpb.HealthRequest.StringArray")
	proto.RegisterType((*HealthResponse)(nil), "etcdserverpb.HealthResponse")
...
var fileDescriptor_77a6da22d6a3feb1 = []byte{
	...
	,
}
...
type MaintenanceClient interface {
	...
	Livez(ctx context.Context, in *HealthRequest, opts ...grpc.CallOption) (*HealthResponse, error)
	Readyz(ctx context.Context, in *HealthRequest, opts ...grpc.CallOption) (*HealthResponse, error)
...
func (c *maintenanceClient) Livez(ctx context.Context, in *HealthRequest, opts ...grpc.CallOption) (*HealthResponse, error) {
	out := new(HealthResponse)
	err := c.cc.Invoke(ctx, "/etcdserverpb.Maintenance/Livez", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *maintenanceClient) Readyz(ctx context.Context, in *HealthRequest, opts ...grpc.CallOption) (*HealthResponse, error) {
	out := new(HealthResponse)
	err := c.cc.Invoke(ctx, "/etcdserverpb.Maintenance/Readyz", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *maintenanceClient) Healthz(ctx context.Context, in *HealthRequest, opts ...grpc.CallOption) (*HealthResponse, error) {
	out := new(HealthResponse)
	err := c.cc.Invoke(ctx, "/etcdserverpb.Maintenance/Healthz", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MaintenanceServer interface {
	...
	Livez(context.Context, *HealthRequest) (*HealthResponse, error)
	Readyz(context.Context, *HealthRequest) (*HealthResponse, error)
...
func (*UnimplementedMaintenanceServer) Livez(ctx context.Context, req *HealthRequest) (*HealthResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Livez not implemented")
}
func (*UnimplementedMaintenanceServer) Readyz(ctx context.Context, req *HealthRequest) (*HealthResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Readyz not implemented")
}
func (*UnimplementedMaintenanceServer) Healthz(ctx context.Context, req *HealthRequest) (*HealthResponse, error) {
...
func _Maintenance_Livez_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(HealthRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MaintenanceServer).Livez(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/etcdserverpb.Maintenance/Livez",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MaintenanceServer).Livez(ctx, req.(*HealthRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Maintenance_Readyz_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(HealthRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MaintenanceServer).Readyz(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/etcdserverpb.Maintenance/Readyz",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MaintenanceServer).Readyz(ctx, req.(*HealthRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Maintenance_Healthz_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(HealthRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MaintenanceServer).Healthz(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/etcdserverpb.Maintenance/Healthz",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MaintenanceServer).Healthz(ctx, req.(*HealthRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Maintenance_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Livez",
			Handler:    _Maintenance_Livez_Handler,
		},
		{
			MethodName: "Readyz",
			Handler:    _Maintenance_Readyz_Handler,
		},
		{
			MethodName: "Healthz",
			Handler:    _Maintenance_Healthz_Handler,
		},
		{
			MethodName: "Status",
...
func (m *HealthRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.HealthCheckSelector != nil {
		{
			size := m.HealthCheckSelector.Size()
			i -= size
			if _, err := m.HealthCheckSelector.MarshalTo(dAtA[i:]); err != nil {
				return 0, err
			}
		}
	}
...
func (m *HealthRequest_Exclude) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *HealthRequest_Exclude) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Exclude != nil {
		{
...
func (m *HealthRequest_Allowlist) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *HealthRequest_Allowlist) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Allowlist != nil {
		{
...
func (m *HealthRequest_StringArray) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *HealthRequest_StringArray) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *HealthRequest_StringArray) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *HealthResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Reason) > 0 {
		...
		i = encodeVarintRpc(dAtA, i, uint64(len(m.Reason)))
		i--
		dAtA[i] = 0x1a
	}
	if m.Ok {
...
func (m *HealthRequest_Exclude) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *HealthRequest_Allowlist) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *HealthRequest_StringArray) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *HealthRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			v := &HealthRequest_StringArray{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.HealthCheckSelector = &HealthRequest_Exclude{v}
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
			...
			m.HealthCheckSelector = &HealthRequest_Allowlist{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipRpc(dAtA[iNdEx:])
...
func (m *HealthRequest_StringArray) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
