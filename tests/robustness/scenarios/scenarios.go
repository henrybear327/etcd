...
func Regression(t *testing.T) []TestScenario {
	...
	scenarios = append(scenarios, TestScenario{
		Name:      "issue20221",
		Profile:   traffic.HighTrafficProfile.WithoutCompaction().WithBackgroundWatchConfigInterval(10 * time.Millisecond).WithBackgroundWatchConfigRevisionOffset(100),
